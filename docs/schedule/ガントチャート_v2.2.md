...
**主目標：** **2026-08-31 までに、4画面をローカルデータで通し操作できる最小MVPを Cloudflare Pages で公開する。**
...
gantt
    ...
    section P6 発表準備
    #18 インタビュー・アンケート整理 :done, p0b, 2026-10-10, 2026-10-23
...
- **基盤（M-Base）は完了済み**です。PWA雛形、4画面の骨組み、機能IF、ローカル永続化、ディスクレーマー、デバッグモード、Cloudflare Pages自動デプロイ設定、PRチェックCIは構成済みです（#23〜#29、#40、#58、#73、#76、#80、#81、#107、#113）。
...
gantt
    ...
    #46 公開前修正・Cloudflare Pages公開         :crit, release, 2026-08-25, 2026-08-31
    ★ M-MVP Cloudflare Pages公開                :milestone, mmvp, 2026-08-31, 0d
...
| **P1** | #110 週次統合ルール | Issue open・PR #128 mergeable | 全員（運用責任：村上） | 07/17開始 | 人間が運用を合意・マージし、毎週金曜のdevelop通しデモとmainリリース後のCloudflare Pages公開URL確認結果を記録する。 |
...
| **P2** | #46 M-MVP公開 | Issue open（Cloudflare Pages自動デプロイ基盤は完了） | 村上 / 全員 | **08/31** | #41/#42/#43/#108と公開前修正が完了し、公開URLで4画面の通し操作が成功すること。 |
...
1. Cloudflare Pagesの公開URLで、**初回チェック → 結果/ロードマップ → 商品候補・比較 → 継続記録**を止まらずに操作できる。
